...
namespace InfimaGames.LowPolyShooterPack
{
	...
	public sealed class Character : CharacterBehaviour
	{
		...
		/// <summary>
		/// True if the crosshair should be forced to be hidden (e.g., when paused).
		/// </summary>
		private bool crosshairForcedHidden;
		...
		public override bool IsCrosshairVisible() => !crosshairForcedHidden && !aiming && !holstered;
		...
		/// <summary>
		/// Set crosshair forced hidden state.
		/// </summary>
		public void SetCrosshairForcedHidden(bool hidden)
		{
			crosshairForcedHidden = hidden;
		}
